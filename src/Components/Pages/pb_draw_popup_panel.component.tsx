    ...
    return(
        <>
            <div className="bg-white h-full flex flex-col border-solid border-2 border-black rounded-lg z-[50] relative">
                ...
                <div className={"flex flex-col bg-[#FCE6D2] w-[95%] mx-auto mt-2 rounded-xl "+ (isPanelVisible ? "h-[8rem] ease-in-out duration-300" : "h-[4rem] ease-in-out duration-300")}>
                    <div className="my-2 flex flex-row">
                        ...
                        <div className="h-auto w-full flex flex-row py-1 justify-end">    
                            <div className="ball-result-casing  h-5 border-2 border-solid border-slate-400 bg-slate-200 rounded-2xl flex flex-row px-2 text-xs font-semibold">
                            ...
                            <button type="button" className={"btn-up mx-5 "+ (isPanelVisible ? "rotate-0 ease-in-out duration-300 ": "rotate-180 ease-in-out duration-300 ")} onClick={(e) => togglePanel(e)}>
                    ...
                    <div className={"bg-white border-solid border-2 border-b-[0.4rem] p-2 border-black rounded-lg  w-[95%] mx-auto flex flex-row "+ (isPanelVisible ? "h-[50%]" : "h-[0%] p-0 m-0 hidden")}>
                ...
                <div className="flex flex-col bg-[#FCE6D2] w-[95%] h-[8rem] mx-auto mt-2 rounded-xl">
                    <div className="my-2 flex flex-row">
                        ...
                        <div className="h-auto w-full flex flex-row py-1 justify-end">    
                            ...
                            <button type="button" className="btn-up mx-5">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.54 14.6404C20.54 15.0626 20.3627 15.4848 20.0082 15.7861C19.3988 16.3039 18.4683 16.1897 17.9029 15.6243L12.0361 9.75807L6.09179 15.7024C5.50585 16.2884 4.55663 16.2884 3.9707 15.7024C3.38477 15.1165 3.38476 14.1673 3.9707 13.5813L11.329 6.22213C11.7195 5.83156 12.3527 5.83155 12.7433 6.22211L20.1006 13.5799C20.3936 13.8728 20.54 14.2566 20.54 14.6404Z" fill="#000"></path></svg>
                            </button>
                    ...
                    <div className="bg-white border-solid border-2 border-b-[0.4rem] p-2 border-black rounded-lg h-[50%] w-[95%] mx-auto flex flex-row">
                        <div className="flex flex-col text-start w-1/2 text-sm">
                            <p>파워볼홀</p>
                            <p>
                                <span className="font-bold text-orange-700 mr-2">₩1,000</span> 
