...
function PBBettingFormComponent(props) {
    ...
    console.log(props.isBettingFormVisible)

    return(
        <>
            <div className="bg-slate-100 w-[33rem] border-solid border-2 border-black rounded-lg flex flex-col absolute ">
